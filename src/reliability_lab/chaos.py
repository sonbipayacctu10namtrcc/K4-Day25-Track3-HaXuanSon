...
def run_simulation(config: LabConfig, queries: list[str]) -> RunMetrics:
    ...
    for scenario in config.scenarios:
        ...
        # Scenarios that force provider failures are graded on whether the
        # fallback chain kept availability up; healthy-baseline scenarios are
        # graded on raw availability instead.
        if scenario.provider_overrides:
